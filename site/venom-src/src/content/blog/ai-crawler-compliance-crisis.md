...
- Compliance drops sharply with stricter directives: Bytespider (ByteDance) had 0% endpoint-access compliance, ignoring every restriction; Meta accounts for 52% of total AI crawler volume<sup><a href="#ref-7">7</a></sup><sup><a href="#ref-2">2</a></sup>
- Anthropic's crawl-to-refer ratio peaked at 500,000 pages crawled per referral sent back<sup><a href="#ref-3">3</a></sup>
- Publishers are responding: 5.8 million sites now block ClaudeBot<sup><a href="#ref-4">4</a></sup>, top-500 publisher traffic declined 27% year-over-year<sup><a href="#ref-5">5</a></sup>, and the largest AI copyright settlement reached $1.5 billion<sup><a href="#ref-14">14</a></sup>
...
![AI crawler robots.txt non-compliance rate: 3.3% in Q4 2024, 13.26% in Q2 2025, 30% in Q4 2025 -- a nearly tenfold increase in one year](/images/diagrams/crawler-compliance-rate.png)

That is a nearly tenfold increase in one year. And it understates the problem, because it only counts crawlers that identify themselves honestly. DataDome found that 5.7% of AI crawler user-agent strings are spoofed<sup><a href="#ref-6">6</a></sup> -- bots that claim to be browsers or search engine crawlers to bypass robots.txt entirely.
...
- **Google v. SerpApi** (December 2025): Invoking DMCA anti-circumvention provisions for search result scraping<sup><a href="#ref-14">14</a></sup>
